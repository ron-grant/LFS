 /* UserPar    User Parameter Editor  Support added in LFS library 1.4   
    ...
    Note: There have been some enhancements to UserInit. Take a look at it
    (Current goal is to make comments a bit more terse in the file - Oct,24,2020 looking
    to pull out into update document possibly to make a bit cleaner)
