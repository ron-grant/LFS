...
*/
 ...
 void userStop() {}                 // additional actions to take when S)top command issued        (lib 1.4.3)
                                    // at present controller disabled and robot commanded to stop
...
void userMarkerClicked()   {}  // optional user method. Note LFS is taking care of state save/restore 
                               // see UserReset tab header. Also see LFS_RS or if not present see LFS_M
